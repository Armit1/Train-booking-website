...
<%
	...
	if(request.getParameter("submitNum") != null) {
		...
		ArrayList<Integer> res_nums = (ArrayList<Integer>) session.getAttribute("array");
		int res_num = res_nums.get(submitNum);
		...
		try{
			...
			PreparedStatement preparedStatement = connection
					.prepareStatement("DELETE from reservations where res_num = ?");
...
ResultSet resultSet = null;
%>
<h2 align="center"><font><strong>Present Reservation Portfolio</strong></font></h2>
...
ArrayList<Integer> res_nums = new ArrayList<Integer>();
...
while(resultSet.next()){
	...
	int res_num = Integer.parseInt(resultSet.getString("res_num"));
...
session.setAttribute("array", res_nums);
...
<p> Input a selection number if you would like to cancel a reservation </p>
