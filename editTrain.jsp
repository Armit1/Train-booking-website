...
<body>
	...
	try {
		...
		{
		check = "update run_on set origin = ? where trainID = ?";
		}
		else if (command.equals("destination"))
		{
		check = "update run_on set destination= ? where trainID = ?";
		}
		else if (command.equals("transit"))
		{
		check = "update run_on set transit_line = ? where trainID = ?";
		}
		else if (command.equals("travel"))
		{
		check = "update run_on set travel_time = ? where trainID = ?";
		}
		else if (command.equals("arrive"))
		{
		check = "update run_on set arrival = ? where trainID = ?";
		}
		else
		{
		check = "update run_on set destination = ? where trainID = ?";
